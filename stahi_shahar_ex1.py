...
def main():
    ...
    # wiki_dir = os.path.join(os.getcwd(), 'Wiki_files')
    output_file = argv[3]
    # output_file = os.path.join(os.getcwd(), 'output.txt')

    # 1. Create a corpus object.
